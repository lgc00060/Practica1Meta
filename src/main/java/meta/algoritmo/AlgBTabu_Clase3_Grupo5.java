...
public class AlgBTabu_Clase3_Grupo5 {
    ...
    public static void algBTabuClase1Grupo5(long semilla, long iteraciones, double[] soluActu, int tam, double rmin, double rmax, String funcion, double oscilacion, Logger logger) {
        ...
        int osc = 0;
        int tenenciaTabu = 0;
        long memoriaFrec[][] = new long[10][10];
        ...
        logger.info("Empieza ejecucion TABU: ");
        ...
        while (iter < iteraciones) {
            ...
            if (contNoTabu != 0) {
                ...
                if (contador == 50) {
                    ...
                    if (prob <= 50) {
                        osc = 0;
                        diversificacion(memoriaFrec, solNu, rmin, rmax);
                    } else {
                        osc = 1;
                        intensificacion(memoriaFrec, solNu, rmin, rmax);
                    }
        ...
        logger.info("El coste del algoritmo tabu es:" + costeActual);
